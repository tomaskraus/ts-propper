...
//=> big radius: false
// Use that function:
const onlyBigCircles = twoTimesBiggerCircles.filter(radiusProp.evaluate(isValueBig));
...
const onlyBigCircles2 = twoTimesBiggerCircles.filter((c) => isValueBig(c.r) // Without use of Propper, this line should be edited every time Circle type radius name or place is changed.
);
